...
$(document).ready(function () {
    ...
    $("body").hasClass("vertical-modern-menu") || $("body").hasClass("vertical-menu-nav-dark") ? $(".menu-bg-color").hide() : $("body").hasClass("vertical-gradient-menu") || $("body").hasClass("vertical-dark-menu") ? ($(".menu-color").hide(), (menuBgDefault = !0)) : $("body").hasClass("horizontal-menu") && $(".menu-options").hide(),
