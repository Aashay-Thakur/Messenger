                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    return (
                                        "bottom" === h && (o = o - e.height + (this.options.coverTrigger ? t.height : 0)), "right" === d && (s = s - e.width + t.width), { x: s, y: o, verticalAlignment: h, horizontalAlignment: d, height: i, width: n }
                                    );
                                },
                            },
                            {
            ...
            t = (function (t) {
                function n(t, e) {
                    ...
                    return i.$el.hasClass("browser-default")
                        ...
                        : (((i.el.M_FormSelect = i).options = d.extend({}, n.defaults, e)), (i.isMultiple = i.$el.prop("multiple")), (i.el.tabIndex = -1), (i._keysSelected = {}), (i._valueDict = {}), i._setupDropdown(), i._setupEventHandlers(), i);
                }
                return (
                    _inherits(n, Component),
                    _createClass(
