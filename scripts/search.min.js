...
$(function () {
    ...
    $(".search-sm-close").on("click", function () {
        ...
        $(".header-search-wrapper .header-search-input, .search-input-sm .search-box-sm").on("keyup", function (e) {
                ...
                if (($("ul.search-list li").remove(), "" != t)) {
                    ...
                    $.getJSON("../../../app-assets/data/" + a + ".json", function (e) {
                        for (var s = 0; s < e.listItems.length; s++)
                            ((0 == e.listItems[s].name.toLowerCase().indexOf(t) && n < 4) || (0 != e.listItems[s].name.toLowerCase().indexOf(t) && -1 < e.listItems[s].name.toLowerCase().indexOf(t) && n < 4)) &&
                                ((i +=
            ...
            $(".header-search-wrapper .current_item").length && (searchList.scrollTop(0), searchList.scrollTop($(".search-list .current_item:first").offset().top - searchList.height())),
                $(".search-input-sm .current_item").length && (searchListSm.scrollTop(0), searchListSm.scrollTop($(".search-list-sm .current_item:first").offset().top - searchListSm.height()));
        }),
        ...
        $(window).on("keydown", function (e) {
            ...
            if (
                (40 === e.keyCode ? ((s = r.next()), r.removeClass("current_item"), (r = s.addClass("current_item"))) : 38 === e.keyCode && ((a = r.prev()), r.removeClass("current_item"), (r = a.addClass("current_item"))),
