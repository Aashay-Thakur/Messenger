...
defaultMenuCollapse(),
    ...
    $(function () {
        ...
        if (
            ...
            (t =
                0 < $(".sidenav-main li a.active").parent("li.active").parent("ul.collapsible-sub").length
        ...
        0 < r.length && (r[0].scrollTop = r[0].scrollHeight),
            ...
            i18next.use(window.i18nextXHRBackend).init({ debug: !1, fallbackLng: "en", backend: { loadPath: "../../../app-assets/data/locales/{{lng}}.json" }, returnObjects: !0 }, function (e, n) {
